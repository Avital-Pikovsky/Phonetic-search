...
int main()
{
	...
	try
	{
		cout << phonetic::find(text, "haff") << endl; // should throw an exception - "happ" is not a full word in the sentence
	}
	catch (exception &ex)
	{
		cout << "   hgfdfghjhcaught exception: " << ex.what() << endl; // should print "Did not find the word 'happ' in the text"
	}
}
